...
class EventSerializer(DocumentSerializer):
    ...
    class Meta:
        model = Events
        depth = 1
        fields = ('id', 'thumbnail', 'title', 'start_date', 'creation_date', 'creator', 'tags', 'participants', 'level', 'address', 'description', 'priv_or_pub', 'nbrParticipantsMax') #'start_date', 'end_date', 'price', 'name', 'user_id')
