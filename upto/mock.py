...
#Create Tags
t1=Tags.objects.create(title='#Cinema')
t2=Tags.objects.create(title='#Running')
t3=Tags.objects.create(title='#Foot')
t4=Tags.objects.create(title='#Museum')
t5=Tags.objects.create(title='#Dancing')
t6=Tags.objects.create(title='#Cooking')
t7=Tags.objects.create(title='#Chess')
t8=Tags.objects.create(title='#Cycling')
